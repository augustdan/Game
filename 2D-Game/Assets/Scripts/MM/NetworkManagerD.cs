...
namespace Game
{
    public class NetworkManagerD : NetworkManager
    {
        ...
        public void CreateSubScenesForGame()
        {
            SceneManager.LoadSceneAsync(roomScene, new LoadSceneParameters { loadSceneMode = LoadSceneMode.Additive, localPhysicsMode = LocalPhysicsMode.Physics3D });
            Scene SceneRoom = SceneManager.GetSceneByBuildIndex(3);
            
            
            Debug.Log("Sub Scene Has Loaded");
        }
